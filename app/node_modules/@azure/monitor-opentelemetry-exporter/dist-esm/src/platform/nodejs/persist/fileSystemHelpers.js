 ...
 */
exports.getShallowDirectorySize = function (directory) { return __awaiter(void 0, void 0, void 0, function () {
    var files, totalSize, _i, files_1, file, fileStats;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, readdirAsync(directory)];
            case 1:
                files = _a.sent();
                totalSize = 0;
                _i = 0, files_1 = files;
            ...
            case 2:
                ...
                file = files_1[_i];
                return [4 /*yield*/, statAsync(path.join(directory, file))];
            case 3:
                fileStats = _a.sent();
                if (fileStats.isFile()) {
...
exports.confirmDirExists = function (directory) { return __awaiter(void 0, void 0, void 0, function () {
    var stats, err_1, mkdirErr_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 7]);
                return [4 /*yield*/, lstatAsync(directory)];
            case 1:
                stats = _a.sent();
